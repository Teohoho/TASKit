...
##Test load
test_load1 = TASKit.TrajHandle.TrajLoader(prmtop="test/Peptide_01.prmtop", DCDS="test/Peptide_01.dcd", stride=1)
test_load2 = TASKit.TrajHandle.TrajLoader(prmtop="test/Peptide_02.prmtop", DCDS="test/Peptide_02.dcd", stride=1)
...
Clusters.GenerateHeatmap(saveHTML="testClust.html", show=True, FrameIntervals=RMSDMat.frameIntervals)
